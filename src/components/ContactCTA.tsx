...
const ContactCTA: React.FC = () => {
  return (
    <section id="contact-hub" className="bg-faeDark text-white py-24 px-4 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10 animate-fade-in-up">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Engineering Card */}
          <div className="bg-white text-faeDark p-10 flex flex-col items-start hover:-translate-y-2 transition-transform duration-300 border-t-4 border-faeCyan">
            <SupportAgentOutlinedIcon fontSize="large" className="text-faeCyan mb-6" />
            ...
            <a 
              ...
              className="inline-flex items-center text-faeDark font-bold uppercase tracking-widest hover:text-faeCyan transition-colors"
            >
          ...
          {/* Supply Chain Card */}
          <div className="bg-white text-faeDark p-10 flex flex-col items-start hover:-translate-y-2 transition-transform duration-300 border-t-4 border-faeCyan">
            <LocalShippingOutlinedIcon fontSize="large" className="text-faeCyan mb-6" />
